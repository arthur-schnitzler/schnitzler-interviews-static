...
<xsl:stylesheet 
    ...
    <xsl:template match="/">
        <xsl:variable name="doc_title">
            <xsl:value-of select="descendant::tei:titleSmt/tei:title[@level='a']/text()"/>
        </xsl:variable>
                        ...
                        <div class="row intro">
                            <div class="col-md-6 col-lg-6 col-sm-12 wp-intro_left">
                                <div class="intro_left">
                                    <h1>Arthur Schnitzler: Das Zeitlose ist von kürzester Dauer. Interviews, Meinungen, Proteste</h1>
                                    <h3>schnitzler-interviews</h3>
