    ...
    <xsl:template name="header-nav">
        ...
        <div class="row" id="title-nav">
            <div class="col-md-2 col-lg-2 col-sm-12">
                <xsl:if test="ends-with($prev, '.html') and not($prev='.html')">
                    <h1>
                        <a>
                            ...
                            <xsl:attribute name="title">
                                <xsl:value-of
                                    select="document(concat($prev, '.xml'))/descendant::tei:titleStmt[1]/tei:title[@level = 'a'][1]"
                                />
                            </xsl:attribute>
            ...
            <div class="col-md-2 col-lg-2 col-sm-12" style="text-align:right">
                <xsl:if test="ends-with($next, '.html')  and not($next='.html')">
                    <h1>
                        <a>
                            <xsl:attribute name="href">
                            ...
                            <xsl:attribute name="title">
                                <xsl:value-of
                                    select="document(concat($next, '.xml'))/descendant::tei:titleStmt[1]/tei:title[@level = 'a'][1]"
                                />
                            </xsl:attribute>
