        ...
        <nav class="navbar navbar-expand-md" style="padding-top:1px;">
            <div class="container-fluid">
                <a href="index.html" class="navbar-brand custom-logo-link" rel="home" itemprop="url">
                    <img src="images/schnitzler-interviews.svg" class="img-fluid" title="schnitzler-interviews" alt="schnitzler-interviews" itemprop="logo"/>
                </a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item dropdown-submenu">
                                    <a class="nav-link" href="editorisch.html">Editionsrichtlinien</a>
                                </li>
                                <li class="nav-item dropdown-submenu">
